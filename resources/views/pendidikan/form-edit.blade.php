                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{route('pendidikan.update', $pendidikan->id)}}" method="POST">
                        ...
                        <div class="flex flex-col mb-2">
                            ...
                            <input type="text" id="name" name="name" class="w-fit border-t-transparent border-l-transparent border-r-transparent focus:ring-0 border-b border-teal-600" value="{{old('name', $pendidikan->name)}}"
                                required>
                        </div>
